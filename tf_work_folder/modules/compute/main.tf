...
resource "aws_lambda_function" "lambda_web_logic_core" {
    ...
    filename      = data.aws_s3_bucket_object.lambda_web_logic_core_zip_local.body_path 
    source_code_hash = data.aws_s3_bucket_object.lambda_web_logic_core_zip_local.etag
